...

  {
    ...
    children: [

      {
        ...
        name: 'ExamOnline',
        meta: { title: '错题重做', noCache: true, icon: 'guide' }
      },

      {
        ...
        name: 'PreExam',
        meta: { title: '开始测验', noCache: true, activeMenu: '/my/exam' },
        hidden: true
      },

      {
        ...
        name: 'ShowExam',
        meta: { title: '错题重做结果', noCache: true, activeMenu: '/online/exam' },
        hidden: true
      },

      {
        ...
        name: 'ListMyExam',
        meta: { title: '错题重做结果', noCache: true, icon: 'results' }
      },
...

  {
    ...
    children: [

      {
        ...
        name: 'ListRepo',
        meta: { title: '错题库管理', noCache: true, icon: 'repo' }
      },

      {
        ...
        name: 'AddRepo',
        meta: { title: '添加错题库', noCache: true, activeMenu: '/exam/repo' },
        hidden: true
      },

      {
        ...
        component: () => import('@/views/qu/repo/form'),
        name: 'UpdateRepo',
        meta: { title: '错题库详情', noCache: true, activeMenu: '/exam/repo' },
        hidden: true
      },

      {
        ...
        name: 'ListQu',
        meta: { title: '错题管理', noCache: true, icon: 'support' }
      },

      {
        ...
        name: 'AddQu',
        meta: { title: '添加错题', noCache: true, activeMenu: '/exam/qu' },
        hidden: true
      },

      {
        ...
        component: () => import('@/views/qu/qu/form'),
        name: 'UpdateQu',
        meta: { title: '修改错题', noCache: true, activeMenu: '/exam/qu' },
        hidden: true
      },

      {
        ...
        name: 'ListExam',
        meta: { title: '错题重做测验管理', noCache: true, icon: 'log' }
      },

      {
        ...
        name: 'AddExam',
        meta: { title: '添加错题重做', noCache: true, activeMenu: '/exam/exam' },
        hidden: true
      },

      {
        ...
        component: () => import('@/views/exam/exam/form'),
        name: 'UpdateExam',
        meta: { title: '修改错题重做', noCache: true, activeMenu: '/exam/exam' },
        hidden: true
      },
      {
        ...
        name: 'ListExamUser',
        meta: { title: '人员', noCache: true, activeMenu: '/exam/exam' },
        hidden: true
      },
      {
        ...
        name: 'ListPaper',
        meta: { title: '记录', noCache: true, activeMenu: '/exam/exam' },
        hidden: true
      }
    ]
  },
