<template>
  ...
  >
    <template slot="filter-content">
      ...
      <el-input v-model="listQuery.params.title" placeholder="搜索错题重做测验名称" style="width: 200px;" class="filter-item" />
    ...
    <template slot="data-columns">
      ...
      >
        <template slot-scope="scope">
          ...
          <el-button type="warning" size="mini" icon="el-icon-user" @click="handleExamDetail(scope.row.id)">详情</el-button>
        </template>
      </el-table-column>
