  ...
  <div class="app-container">
    ...
    <el-card style="margin-top: 20px">
      ...
      <el-form ref="postForm" :model="postForm" :rules="rules" label-position="left" label-width="120px">
        ...
        <el-form-item label="错题重做测验名称" prop="title">
          <el-input v-model="postForm.title" />
        </el-form-item>

        <el-form-item label="错题重做测验描述" prop="content">
        ...
        <el-form-item v-if="postForm.timeLimit" label="时间" prop="totalTime">
    ...
    <el-card style="margin-top: 20px;">
      ...
      <el-radio-group v-model="postForm.openType" style="margin-bottom: 20px">
        ...
        <el-radio :label="2" border>指定班级开放</el-radio>
      </el-radio-group>

      <el-alert
        v-if="postForm.openType===1"
        title="开放的，任何人都可以进行错题重做！"
        type="warning"
      />
