  ...
  <div>
    ...
    >
      ...
      <template slot="data-columns">
        ...
        >
          <template slot-scope="scope">
            <el-button type="primary" size="mini" icon="el-icon-view" @click="handleExamDetail(scope.row.examId, scope.row.userId)">明细</el-button>
          </template>
    ...
    <el-dialog :visible.sync="dialogVisible" title="明细" width="60%">
